...
This document is Language::MuldisD::Dialect::PTMD_Tiny version 0.11.1.
...
See also, for example, L<Language::MuldisD::Dialect::HDMD_Perl_Tiny> for a
description of the core Perl data structures that you would probably use
instead of the grammar below when using a Muldis D implementation in a Perl
application; moreover, that other document is necessary to understand the
meaning of some parts of this PTMD_Tiny document.
...
correctly.  Any remaining errors should be corrected as soon as possible.
    ...
    # grammar MuldisD:auth<cpan:DUNCAND>:ver<0.11.1>;
    grammar MuldisD-0.11.1-cpan:DUNCAND;
