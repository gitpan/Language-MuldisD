...
This document is Language::MuldisD::Basics version 0.13.1.
...
L<Language::MuldisD::Dialect::PTMD_Tiny> for the grammar of Concrete Muldis
D; the latter document says how to parse Concrete Muldis D into Abstract
Muldis D; the former document explains the meaning of both in terms of the
Abstract; see L<Language::MuldisD::Dialect::HDMD_Perl_Tiny> for Perl Hosted
Abstract Muldis D.
